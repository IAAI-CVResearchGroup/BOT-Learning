# ======================================
# Filename: RetrievalEvaluation.py
# Description: Evaluate and test the learned embeddings.
...
def RetrievalEvaluation(C_depth, distM, model_label, depth_label, testMode=1):
	...
	for qqq in tqdm(range(nb_of_query)):
		temp_dist = distM[qqq]
...
# RetrievalEvaluation.py ends here.
# =====================================