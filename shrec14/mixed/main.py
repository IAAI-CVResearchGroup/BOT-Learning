...
#parser.add_argument('--ckpt_dir', dest='ckpt_dir', type=str, default='/data/checkpoint/shrec14', help='directory for saving checkpoint')
parser.add_argument('--batch_size', dest='batch_size', type=int, default=30, help='# images in batch')
parser.add_argument('--margin', type=float, default=1, help='The margin of contrastive loss')
